        ...
        <div class="row">
            ...
            <div class="col-md-3 bg-light p-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item">
                        <a class="nav-link active" href="{{ route('admin.dashboard') }}">داشبورد</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.complaints') }}">مدیریت شکایات</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.reports') }}">گزارشات</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.users') }}">لیست کاربران</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('admin.create_user') }}">ساخت اکانت کاربری</a>
                    </li>
                </ul>
            </div>
            <!-- محتوای اصلی -->
